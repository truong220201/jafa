...
/// @nodoc
abstract class _$$_MemberInfoModelCopyWith<$Res>
    implements $MemberInfoModelCopyWith<$Res> {
  factory _$$_MemberInfoModelCopyWith(
          _$_MemberInfoModel value, $Res Function(_$_MemberInfoModel) then) =
      __$$_MemberInfoModelCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int? id,
...
/// @nodoc
class __$$_MemberInfoModelCopyWithImpl<$Res>
    extends _$MemberInfoModelCopyWithImpl<$Res, _$_MemberInfoModel>
    implements _$$_MemberInfoModelCopyWith<$Res> {
  __$$_MemberInfoModelCopyWithImpl(
      _$_MemberInfoModel _value, $Res Function(_$_MemberInfoModel) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_MemberInfoModel(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$_MemberInfoModel extends _MemberInfoModel {
  const _$_MemberInfoModel(
      {this.id,
      this.name,
  ...
  factory _$_MemberInfoModel.fromJson(Map<String, dynamic> json) =>
      _$$_MemberInfoModelFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_MemberInfoModelCopyWith<_$_MemberInfoModel> get copyWith =>
      __$$_MemberInfoModelCopyWithImpl<_$_MemberInfoModel>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_MemberInfoModelToJson(
      this,
    );
  }
}
...
abstract class _Detail extends Detail {
  const factory _Detail(
      ...
      @JsonKey(name: 'role_id') final int? roleId}) = _$_Detail;
