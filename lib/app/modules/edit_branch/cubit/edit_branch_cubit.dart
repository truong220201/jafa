...
import '../repository/edit_branch_repository.dart';
import 'edit_branch_state.dart';

class EditBranchCubit extends Cubit<EditBranchState> {
  EditBranchCubit(this._editBranchRepository) : super(const EditBranchState());

  final EditBranchRepository _editBranchRepository;
  ...
  void editBranch({
    ...
    try {
      ...
      await _editBranchRepository.editBranch(
  ...
  void getBranch({
    ...
    try {
      final user = await _editBranchRepository.getBranch(
